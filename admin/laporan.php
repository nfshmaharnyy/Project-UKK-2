...
<head>
    ...
    <title>Laporan Peminjaman (Admin) | Sakura Library</title>
...
<div class="container">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center mb-4 no-print">
        <h2 class="sakura-text mb-3 mb-md-0"><i class="bi bi-shield-lock-fill me-2"></i>Laporan Peminjaman (Admin)</h2>
    ...
    <div class="card sakura-card p-4 shadow-sm">
        <div class="text-center mb-5">
            ...
            <p class="text-muted small">Sakura Digital Library - Dashboard Administrator</p>
        ...
        <div class="mt-5 d-none d-print-block">
            <div class="row">
                ...
                <div class="col-4 text-center">
                    ...
                    <p>Mengetahui, <strong>Administrator</strong></p>
                    <div style="height: 80px;"></div>
                    <p class="mb-0"><strong>( <?= htmlspecialchars($_SESSION['nama'] ?? 'Admin'); ?> )</strong></p>
                    <p class="small text-muted">Akses Tingkat Tinggi</p>
                </div>
            </div>
        </div>
    </div>
