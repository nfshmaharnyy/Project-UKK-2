...
if (isset($_POST['daftar'])) {
    ...
    if (mysqli_num_rows($cek_user) > 0) {
        ...
        $query = mysqli_query($koneksi, "INSERT INTO user (username, password, email, nama_lengkap, alamat, role) 
                  VALUES ('$username', '$password', '$email', '$nama', '$alamat', '$role')");
...
<head>
    ...
    <title>Daftar Peminjam | Sakura Library</title>
    ...
    <style>
        ...
        .form-control { border-radius: 15px; border: 2px solid #fed7e2; padding: 12px 15px; }
        .form-control:focus { border-color: #ed64a6; box-shadow: 0 0 0 0.25rem rgba(237, 100, 166, 0.1); }
...
<div class="register-card">
    <div class="card-header-sakura">
        ...
        <h3 class="mb-0 fw-bold">Daftar Anggota</h3>
        <p class="small mb-0 opacity-75">Satu akun untuk akses ribuan buku digital</p>
    </div>
    ...
    <div class="p-4 p-md-5">
        ...
        <form method="post">
            ...
            <button type="submit" name="daftar" class="btn btn-sakura w-100 mb-3">
                Daftar Sekarang <i class="bi bi-arrow-right-short ms-1"></i>
            </button>
        </form>

        <div class="text-center mt-4">
            <p class="small text-muted mb-0">Sudah punya akun? <a href="login.php">Login di sini</a></p>
        </div>
    </div>
</div>
